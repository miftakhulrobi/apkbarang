		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-primary update-pro" href="add.php"><i class="glyphicon glyphicon-plus"></i><span> Tambah User</span></a>
				</div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
...
<form method="post" action="proses.php">
    <div style="margin-left:20px; margin-right:20px;" class="table-responsive">
        <table class="table table-striped table-bordered table-hover" id="tb_user">
            ...
            $no = 1;
            $user = new User();
            $tampil_user = $user->tampil();
            while($data = $tampil_user->fetch(PDO::FETCH_OBJ)) {
            ?>         
                <tr style="">
                    <td><?=$no++?></td>
                    ...
                    <td align="center">
                        ...
                        <a onclick="return confirm('Yakin Menghapus Data?')" href="del.php?id=<?=$data->id_user?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>                            
                </tr>
            <?php
            }
