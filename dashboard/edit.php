...
<body>
    ...
    <script src="../template/assets/libs/vendor/ckeditor/ckeditor.js"></script>
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
                ...
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-warning update-pro" href="index.php"><i class="glyphicon glyphicon-chevron-left"></i><span> </span></a>
				</div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
