        ...
        <div class="col-lg-6 col-lg-offset-3">
            <form action="proses_stok.php" method="post">
                ...
                <div class="form-group">
                    <label for="stok">Jumlah Stok Saat ini : <?=$data->stok_barang?></label>
                    <input type="number" name="stok" id="stok" class="form-control" placeholder="+" required autofacus>
                </div>
				<div class="form-group">
                    <label for="harga_barang">Harga Saat ini : <?=$data->harga_barang?></label>
                    <input type="number" name="harga_barang" id="harga_barang" class="form-control" placeholder="Rp. " required>
                </div>
                <div class="form-group pull-right">
                    <input type="submit" name="add_stok" value="Tambah" class="btn btn-primary">
                </div>
            </form>
