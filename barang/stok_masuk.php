	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-success update-pro" href="data.php"><i class="glyphicon glyphicon-expand"></i><span> Data Barang</span></a>
				</div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
...
<form method="post" name="proses">
        ...
        <table class="table table-striped table-bordered table-hover" id="tb_barang">
            <thead>
                <tr style="background-color:#07bffc">                    
                    ...
                    <th><i class=""></i> Jumlah Stok</th>
                    <th><i class=""></i> Total Harga</th>
            ...
            ?>
                <tr style="">
					...
					<td>
					<center>
                        <a onclick="return confirm('Yakin Menghapus Data?')" href="del_stok.php?id=<?=$data->id?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
					</center>
					</td>                            
                </tr> 
                <?php
    ...
    <div class="well" style="background-color: #cbc9ca; margin-left:20px; margin-right:20px;">
		<center>
			Total Harga Awal Barang Masuk : <?="Rp. ".number_format($dat[0], 2, ",",".")?>
		</center>
    </div>
</form>
