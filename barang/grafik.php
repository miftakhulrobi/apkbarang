	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-danger update-pro" href="data.php"><i class="glyphicon glyphicon-expand"></i><span> Data Barang</span></a>
				</div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
...
<div id="barang" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
<?php
$li = new Barang();
...
while($data = $tampil->fetch(PDO::FETCH_OBJ)) {
    ...
    $stok_barang[] = intval($data->stok_barang);
}
?>

<script src="../template/assets/highcharts/barang/highcharts.js"></script>
<script src="../template/assets/highcharts/barang/exporting.js"></script>
<script>
