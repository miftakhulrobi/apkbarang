		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-primary update-pro" href="add.php"><i class="glyphicon glyphicon-plus"></i><span> Tambah Transaksi</span></a>
				</div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
...
<form method="post" action="proses.php">
        ...
        <table class="table table-striped table-bordered table-hover" id="tb_user">
            ...
            ?>         
                <tr style="">
                    ...
                    <td align="center">
                        <a onclick="return confirm('Yakin Menghapus Data?')" href="del.php?id=<?=$data->id_transaksi?>" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                    </td>                            
                </tr>
            <?php
			}
    ...
    <div class="well" style="background-color: #cbc9ca; margin-left:20px; margin-right:20px;">
		<center>
			Total Penjualan : <?="Rp. ".number_format($dat[0], 2, ",",".")?>
		</center>
    </div>
</form>
