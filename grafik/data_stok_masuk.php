		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-primary update-pro" href="cetak_stok_semua.php" target="_blank"><i class="glyphicon glyphicon-print"></i><span> Cetak Semua</span></a>
				</div>
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
        ...
        <table class="table table-striped table-bordered table-hover" id="tb_barang">
            ...
            ?>
                <tr style="">
					...
					<td>
					<center>
                        <a href="cetak_stok_per_id.php?id=<?=$data->id?>" target="_blank" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-print"></i> Cetak</a>
					</center>
					</td>                            
                </tr> 
                <?php
