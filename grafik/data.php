		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-warning update-pro" href="data_barang.php"><i class="glyphicon glyphicon-print"></i><span> Data Barang</span></a>
				</div>
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-warning update-pro" href="data_transaksi.php"><i class="glyphicon glyphicon-print"></i><span> Data Transaksi</span></a>
                </div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-warning update-pro" href="data_stok_masuk.php"><i class="glyphicon glyphicon-print"></i><span> Stok Masuk</span></a>
				</div>
                <div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
...
<form action="cetak_tgl.php" method="post" target="_blank">
    <div class="form-group">
        ...
        <input type="date" name="tgl_a" id="tgl_a" class="form-control" required autofocus>
    </div>
    <div class="form-group">
        <label for="tgl_b">Sampai Tanggal</label>
        <input type="date" name="tgl_b" id="tgl_b" class="form-control" required>
    </div>
    <div class="form-group pull-right">
        <input type="submit" name="cetak_tgl" value="Cetak PDF" class="btn btn-primary">
    </div>
</form>
</div>
</div>
