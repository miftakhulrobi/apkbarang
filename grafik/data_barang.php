		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
					<a class="btn btn-primary update-pro" href="cetak_semua_brg.php" target="_blank"><i class="glyphicon glyphicon-print"></i><span> Cetak Semua</span></a>
				</div>
				<div style="margin-right: 10px;" class="navbar-btn navbar-btn-right">
        ...
        <table class="table table-striped table-bordered table-hover" id="tb_barang">
            ...
            ?>
                <tr style="">
                    ...
                    <td align="center">
						<a href="cetak_per_id_brg.php?id=<?=$data->id_barang?>" target="_blank" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-print"></i> Cetak</a>
                    </td>                            
                </tr> 
                <?php
            }
